...
namespace WhirlingInWords.Tests
{
    public class ModSettingsTests
    {
        ...
        public void SonarCategoryEnabled_MapsEveryScanCategoryToItsToggle()
        {
            ...
            Assert.False(settings.SonarCategoryEnabled(WhirlingInWords.Core.World.WorldTaxonomy.Container));
            foreach (string cat in WhirlingInWords.Core.World.WorldTaxonomy.Scan)
                if (cat != WhirlingInWords.Core.World.WorldTaxonomy.Container)
