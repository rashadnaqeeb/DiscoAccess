...
namespace WhirlingInWords.Core.Strings
{
    /// <summary>
    ...
    public static class Strings
    {
        ...
        internal static readonly KeyValuePair<string, string>[] Defaults =
        {
            ...
            // (e.g. "1.0.0"). The mod name mirrors the game's own localization of Whirling-in-Rags
            // (I2 "Area Names/Whirling-int-f1"): translate it where that language translates the
            // name (zh, ko, ru), transliterate where it transliterates (ja, ar), keep the English
            // name where the game keeps it (es, pt-br, fr, de, pl, tr).
            D("ModLoaded", "Whirling in Words {0} loaded"),
        ...
        public static string DumpTemplate()
        {
            ...
            sb.Append("# Whirling in Words authored strings - English template.\n");
