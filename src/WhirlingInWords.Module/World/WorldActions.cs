namespace WhirlingInWords.Module.World
{
    ...
    /// (in <see cref="WhirlingInWords.Core.Input.InputCategory.World"/>); the glide keys are polled as a held
    /// vector each frame, while the verbs fire the <see cref="WorldReader"/>'s handlers. The counterpart to
    /// <see cref="WhirlingInWords.Core.UI.Nav.UiActions"/> for the isometric world.
    /// </summary>
