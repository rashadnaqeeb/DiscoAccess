using System;
using WhirlingInWords.Core.Audio;
using WhirlingInWords.Core.Modularity;
using WhirlingInWords.Core.Strings;
using WhirlingInWords.Core.World;
using WhirlingInWords.Core.World.Overlays;
using WhirlingInWords.Core.World.Overlays.Systems;
using Sunshine.Views;
using UnityEngine;
using PlayMode = WhirlingInWords.Core.World.Overlays.PlayMode; // disambiguate from UnityEngine.PlayMode
using Snv = System.Numerics.Vector3;

namespace WhirlingInWords.Module.World
{
    /// <summary>
    ...
    public sealed class WorldReader : IDisposable
    {
        ...
        public string DevScan()
        {
            ...
            foreach (var cat in WhirlingInWords.Core.World.WorldTaxonomy.All)
            {
